...
Once you have finished Lab 1, at this point you should have at least 3 files in your repo: 
`Owner_yourname.Rmd`, `Partner_yourname.Rmd`, and `Lab1.Rmd` (which should contain the solutions to Part 2 and 3).

After committing all of your work (don't forget to first 'git add FILENAMES'), you should  push your work to GitHub. 
